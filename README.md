...
- اعلان ثابتِ بازشونده برای نمایش فهرست تسک‌های امروز
- اعلان زمان‌دار در تاریخ و ساعت تعیین‌شده برای هر تسک
- کلیک روی خود اعلان یا دکمه آن → باز شدن فرم «افزودن تسک جدید»
